...
class Network(object):
	...
	def SGD(self, training_data, epochs, mini_batch_size, eta,
		...
		evaluation_cost, evaluation_accuracy, evaluation_accuracy_norm = [], [], []
		...
		for j in xrange(epochs):
			...
			if monitor_evaluation_accuracy:
				accuracy = self.accuracy(evaluation_data, tolerance=55.0)
		...
		if plot_results:
			...
			X = epo
			Y_1 = training_cost
			Y_2 = evaluation_accuracy_norm
			axis_1 = fig.add_subplot(111)
			axis_1.set_ylabel("Training Cost", color = 'blue')
			axis_2 = axis_1.twinx()
			axis_2.set_ylabel("Evaluation Accuracy (%)", color = 'red')
			axis_1.set_xlabel("Epoch")

			axis_1.plot(X, Y_1, color="blue", linewidth=2.5, linestyle="-", label="Training Cost")
			axis_2.plot(X, Y_2, color="red", linewidth=2.5, linestyle="-", label="Evaluation Accuracy")
